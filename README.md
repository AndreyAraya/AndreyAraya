...
* **Stack:** `Laravel` | `PHP` | `SQL Server` | `Docker` | [cite_start]`Linux` [cite: 21]

[cite_start]📁 **[Real-Time Chess Game Simulation](https://github.com/AndreyAraya)** [cite: 22]
* **Description:** A synchronized multiplayer chess web application implementing intricate game-state validation logic. [cite_start]Features real-time bidirectional messaging and local server network exposure[cite: 23].
* **Stack:** `PHP` | `JavaScript` | `MySQL` | `Pusher API` | [cite_start]`ngrok` [cite: 23]

[cite_start]📁 **[The GameVault - Digital Store & Library](https://github.com/AndreyAraya)** [cite: 24]
* [cite_start]**Description:** An MVC video game marketplace platform built around secure role-based access controls, enabling complete catalog CRUD management and custom library organization[cite: 25].
* **Stack:** `Laravel` | `PHP` | [cite_start]`MySQL` [cite: 25]

---

### 📜 Certifications
* [cite_start]🥇 **Scrum Foundation Professional Certification (SFPC™)** – *CertiProf* [cite: 36]
* [cite_start]🤖 **Domina la IA con Gemini** – *Santander Open Academy & Google* [cite: 38]
* [cite_start]🛡️ **Introduction to Cybersecurity** – *Cisco Networking Academy* [cite: 37]
* [cite_start]📊 **Intermediate Excel** – *Santander Open Academy* [cite: 39]
...
[cite_start]During my 5 years (2020-2025) as a **Store Administrator & Operations Lead at TecnoPhone**[cite: 27, 28], I leveraged my engineering background to optimize internal processes through a data-driven approach:
* [cite_start]**Internal Technical Support:** Troubleshooted and fixed complex hardware, software, and networking configurations, cutting local system downtime by 20%[cite: 30].
* [cite_start]**Data Analysis & Auditing:** Automated inventory controls and built analytical reports that boosted stock precision by 12%, using metrics to drive real business decisions under pressure[cite: 31].
